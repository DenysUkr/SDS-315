...
# show diffmean hist 
ggplot(boot_3a, aes(x=diffmean) ) + geom_histogram() + labs(title = "Difference in Happy rating")
...
While Living with Ed has slightly more reviews, and having a 0.27 point lead in our sample, this trend should not be applied to the show's overal performance of making someone happy compared to My Name is Earl. We can say with 95% confidence interval that Living with Ed is rated 0.149+-0.249 starts better then My Name is Earl, meaning this is statistically insignificant and practically insignificant.
...
```{r}
# show diffmean hist 
ggplot(boot_3b, aes(x=diffmean) ) + geom_histogram() + labs(title = "Difference in Annoyance rating")
...
ggplot(boot_4, aes(x=diffmean) ) + geom_histogram() + labs(title = "Difference of Price Gas stations with & without competitors")
