...
```{r}
ggplot(data=pr1Data) + geom_boxplot(aes(x=native, y=eval),binwidth = .1 , fill="red4", col="black") + labs(title="Distribution of Course Evaluation Scores Depending on Native English Speaking Professors", y = "Evaluation Score", x="Native English Speaking Profesor") 
