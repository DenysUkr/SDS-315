...
# find the regression model for each data
## split all of the data into idividual stonks 
# fit each graph to find the slope and the intercept 
# find the R^2 value for each equation 
